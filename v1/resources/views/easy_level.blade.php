        ...
        <div class="col-md-8">
            ...
            @foreach($data['question'] as $question)
                ...
                <div class="form-check ms-3 mt-2">
                    <input class="form-check-input" type="radio" name="answer" value="{{$question->question_option1}}" >
                    <label class="form-check-label" for="exampleRadios1">
                    {{$question->question_option1}}
                    </label>
                    </div>
                    <div class="form-check  ms-3 mt-2">
                        <input class="form-check-input" type="radio" name="answer"  value="{{$question->question_option2}}">
                        <label class="form-check-label" for="exampleRadios2">
                        {{$question->question_option2}}
                        </label>
                    </div>
                    <div class="form-check  ms-3 mt-2">
                        <input class="form-check-input" type="radio" name="answer" value="{{$question->question_option3}}">
                        <label class="form-check-label" for="exampleRadios2">
                        {{$question->question_option3}}
                        </label>
                    </div>
                    <div class="form-check  ms-3 mt-2">
                        <input class="form-check-input" type="radio" name="answer"  value="{{$question->question_option4}}">
                        <label class="form-check-label" for="exampleRadios2">
